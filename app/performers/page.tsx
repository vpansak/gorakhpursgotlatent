  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-10">
      ...
      <div className="p-8 rounded-3xl bg-slate-900/80 border border-amber-500/30 text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-slate-300">Submit your application today to perform live in front of thousands.</p>
        <Link href="/apply/performer" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-amber-500 text-black font-extrabold text-sm shadow-lg">
          APPLY AS A PERFORMER NOW
        </Link>
      </div>
    </div>
  );
