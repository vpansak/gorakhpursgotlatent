        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800/80">
            ...
            <Link href="/" className="inline-block">
              <div className="relative w-48 h-16">
                <Image
                  ...
                  fill
                  className="object-contain filter drop-shadow-[0_0_15px_rgba(255,215,0,0.5)]"
                />
              </div>
            </Link>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/tickets" className="hover:text-amber-400 transition-colors font-semibold text-amber-300">Book Show Tickets</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/admin" className="hover:text-amber-400 transition-colors flex items-center gap-1 text-amber-400"><ShieldCheck className="w-4 h-4" /> Admin Portal</Link></li>
            </ul>
          </div>
