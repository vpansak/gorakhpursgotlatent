        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative w-44 h-12 sm:w-56 sm:h-14 transition-transform duration-300 group-hover:scale-105">
                <Image
                  src="/logo.png"
                  alt="Gorakhpur's Got Latent Official Logo"
                  fill
                  priority
                  className="object-contain mix-blend-screen filter drop-shadow-[0_0_15px_rgba(255,215,0,0.5)]"
                />
              </div>
            </Link>
