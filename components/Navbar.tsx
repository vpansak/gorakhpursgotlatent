        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-xl overflow-hidden border border-amber-500/40 shadow-[0_0_15px_rgba(255,215,0,0.4)] transition-transform duration-300 group-hover:scale-105 bg-black">
                <Image
                  src="/logo-emblem.png"
                  alt="Gorakhpur's Got Latent Golden Emblem Logo"
                  fill
                  priority
